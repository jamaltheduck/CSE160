...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7f2ee6a96020, const void *arg_0x7f2ee6a96320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7f2ee6a0e5e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f2ee67b13a0), 
int (*key_eq_fn)(void *arg_0x7f2ee67b1b70, void *arg_0x7f2ee67b1e30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f2ee659ec00, int arg_0x7f2ee659ee80);
static double RandomUniform(void );
...
typedef linkState /*NodeC.routingTableC*/ListC__1__t;
typedef /*NodeC.routingTableC*/ListC__1__t /*NodeC.routingTableC*/ListC__1__List__t;
typedef uint8_t /*NodeC.costListC*/ListC__2__t;
typedef /*NodeC.costListC*/ListC__2__t /*NodeC.costListC*/ListC__2__List__t;
...
static uint16_t /*NodeC.routingTableC*/ListC__1__List__size(void );
static /*NodeC.routingTableC*/ListC__1__List__t /*NodeC.routingTableC*/ListC__1__List__get(uint16_t position);
#line 17
static void /*NodeC.routingTableC*/ListC__1__List__pushback(/*NodeC.routingTableC*/ListC__1__List__t input);
...
static inline void Node__fillRT(void );
...
#line 16
uint16_t /*NodeC.routingTableC*/ListC__1__MAX_SIZE[1000];

/*NodeC.routingTableC*/ListC__1__t /*NodeC.routingTableC*/ListC__1__container[1000][64];
uint16_t /*NodeC.routingTableC*/ListC__1__size[1000];

static inline void /*NodeC.routingTableC*/ListC__1__List__pushback(/*NodeC.routingTableC*/ListC__1__t input);
#line 87
static inline uint16_t /*NodeC.routingTableC*/ListC__1__List__size(void );



static inline /*NodeC.routingTableC*/ListC__1__t /*NodeC.routingTableC*/ListC__1__List__get(uint16_t position);
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f2ee628fe30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f2ee628fe30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f2ee628fe30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f2ee628ea50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f2ee628ea50, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f2ee62a9c70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f2ee62a9c70, msg, error);
#line 110
}
#line 110
...
#line 459
      ...
      if (Node__AMSend__send(dest, &Node__pkt[sim_node()], sizeof(pack )) == SUCCESS) {
          ...
          sim_log_debug(120U, "genDebug", "The radio is busy, or something\n");
          return FAIL;
        }
    }
  else 
#line 469
  ...
  sim_log_debug(121U, "genDebug", "FAILED!?");
  return FAIL;
}
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f2ee5ea6da0, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f2ee5ea6da0) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f2ee5ea6da0, msg, error);
#line 100
      break;
#line 100
    }
...
#line 91
{
  return /*NodeC.routingTableC*/ListC__1__container[sim_node()][position];
}
...
#line 25
  __nesc_result = /*NodeC.routingTableC*/ListC__1__List__get(position);
#line 25
...
#line 87
{
  return /*NodeC.routingTableC*/ListC__1__size[sim_node()];
}
...
#line 24
  __nesc_result = /*NodeC.routingTableC*/ListC__1__List__size();
#line 24
...
#line 21
{
  ...
  if (/*NodeC.routingTableC*/ListC__1__size[sim_node()] < /*NodeC.routingTableC*/ListC__1__MAX_SIZE[sim_node()]) {

      /*NodeC.routingTableC*/ListC__1__container[sim_node()][/*NodeC.routingTableC*/ListC__1__size[sim_node()]] = input;
      /*NodeC.routingTableC*/ListC__1__size[sim_node()]++;
    }
}
...
#line 17
  /*NodeC.routingTableC*/ListC__1__List__pushback(input);
#line 17
}
#line 17
# 373 "Node.nc"
...
#line 315
{
  sim_log_debug(118U, FLOODING_CHANNEL, "START ROUTING\n");
...
#line 298
{
  ...
  if (Node__size[sim_node()] != 0) {
      for (Node__i[sim_node()] = 0; Node__i[sim_node()] < Node__size[sim_node()]; Node__i[sim_node()]++) {
          ...
          sim_log_debug(115U, NEIGHBOR_CHANNEL, "Node %d Neighbor: %d\n", TOS_NODE_ID, Node__neighbor[sim_node()].src);
          sim_log_debug(116U, NEIGHBOR_CHANNEL, "Node %d list size: %d\n", TOS_NODE_ID, Node__size[sim_node()]);
        }
    }
  else {
      sim_log_debug(117U, NEIGHBOR_CHANNEL, "No Neighbors Listed\n");
    }
}
...
#line 75
{
  sim_log_debug(157U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*NodeC.SimpleSendC.PoolC.PoolP*/PoolP__0__free[sim_node()]);
...
#line 289
{
  sim_log_debug(114U, FLOODING_CHANNEL, "PING EVENT \n");
...
#line 22
{
  if (!CommandHandlerP__Queue__empty()) {
      ...
      sim_log_debug(168U, COMMAND_CHANNEL, "A Command has been Issued.\n");
      ...
      switch (commandID) {
          ...
          case CMD_PING: 
            sim_log_debug(169U, COMMAND_CHANNEL, "Command Type: Ping\n");
          CommandHandlerP__CommandHandler__ping(buff[0], &buff[1]);
          break;

          case CMD_NEIGHBOR_DUMP: 
            sim_log_debug(170U, COMMAND_CHANNEL, "Command Type: Neighbor Dump\n");
          CommandHandlerP__CommandHandler__printNeighbors();
          break;

          case CMD_LINKSTATE_DUMP: 
            sim_log_debug(171U, COMMAND_CHANNEL, "Command Type: Link State Dump\n");
          CommandHandlerP__CommandHandler__printLinkState();
          break;

          case CMD_ROUTETABLE_DUMP: 
            sim_log_debug(172U, COMMAND_CHANNEL, "Command Type: Route Table Dump\n");
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f2ee6472020){
#line 75
  switch (arg_0x7f2ee6472020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f2ee6472020);
#line 75
      break;
#line 75
    }
...
#line 78
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f2ee5ea30d0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f2ee5ea30d0, addr, msg, len);
#line 80
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f2ee5bfc950){
#line 83
  switch (arg_0x7f2ee5bfc950) {
#line 83
    case 0U:
#line 83
      Node__timer__fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f2ee5bfc950);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(153U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP__compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP__overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(152U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP__overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(149U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(150U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(142U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(132U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 194
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << OCIE0)) != 0) {
          ...
          sim_log_debug(138U, "HplAtm128Timer0AsyncP", "Compare interrupt @ %s\n", timeStr);
          INTERRUPT_15();
        }
      else {
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << OCF0;
...
#line 225
  sim_log_debug(139U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(144U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 76
  sim_log_debug(161U, "QueueC", "head <-");
  for (i = /*NodeC.SimpleSendC.QueueC*/QueueC__1__head[sim_node()]; i < /*NodeC.SimpleSendC.QueueC*/QueueC__1__head[sim_node()] + /*NodeC.SimpleSendC.QueueC*/QueueC__1__size[sim_node()]; i++) {
      sim_log_debug_clear(162U, "QueueC", "[");
...
#line 81
          sim_log_debug_clear(163U, "QueueC", "%0.2hhx", v);
        }
      sim_log_debug_clear(164U, "QueueC", "] ");
    }
  sim_log_debug_clear(165U, "QueueC", "<- tail\n");
}
...
#line 285
  ...
  sim_log_debug(141U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(147U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 101
      sim_log_debug(127U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) {
              sim_log_debug(128U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(129U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__set[sim_node()]) {
          ...
          sim_log_debug(130U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(148U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(151U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(140U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module ListC__1 */
  if (!strcmp(varname, "/*NodeC.routingTableC*/ListC__1__MAX_SIZE"))
  {
    *addr = (uintptr_t)&/*NodeC.routingTableC*/ListC__1__MAX_SIZE[__nesc_mote];
    *size = sizeof(/*NodeC.routingTableC*/ListC__1__MAX_SIZE[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*NodeC.routingTableC*/ListC__1__container"))
  {
    *addr = (uintptr_t)&/*NodeC.routingTableC*/ListC__1__container[__nesc_mote];
    *size = sizeof(/*NodeC.routingTableC*/ListC__1__container[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*NodeC.routingTableC*/ListC__1__size"))
  {
    *addr = (uintptr_t)&/*NodeC.routingTableC*/ListC__1__size[__nesc_mote];
    *size = sizeof(/*NodeC.routingTableC*/ListC__1__size[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module ListC__1 */
  /*NodeC.routingTableC*/ListC__1__MAX_SIZE[__nesc_mote] = 64;
  memset((void *)&/*NodeC.routingTableC*/ListC__1__container[__nesc_mote], 0, sizeof /*NodeC.routingTableC*/ListC__1__container[__nesc_mote]);
  /*NodeC.routingTableC*/ListC__1__size[__nesc_mote] = 0;
