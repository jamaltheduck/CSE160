...
implementation {
	...
	components new ListC(socket_store_t, 64) as socketListC;
	Node.socketList -> socketListC;
	
	components new ListC(socket_store_t, 64) as usernameListC;
	Node.usernameList -> usernameListC;
	...
	components new TimerMilliC() as closedtimer;
	Node.closedtimer -> closedtimer;
